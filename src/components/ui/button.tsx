  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-neutral-300 border border-neutral-200 shadow-sm [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ghost:
          "border-transparent shadow-none hover:bg-accent hover:text-accent-foreground", // "hover:bg-accent hover:text-accent-foreground",
      ...
      size: {
        default: "h-10 px-4 py-2", // "h-9 px-4 py-2",
        sm: "h-8 rounded-md px-3", // "h-8 rounded-md px-3 text-xs",
        lg: "h-12 rounded-md px-8", // "h-10 rounded-md px-8",
        icon: "h-8 w-8", // "h-9 w-9",
